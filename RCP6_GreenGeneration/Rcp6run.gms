...
Co2Conc.fx("t1850") = c0 +  sum(i, R.l(i,"t1850"))   ;

FCO2.l("t1850") = f1 * log((CO2Conc.l("t1850")+0.001)/c0) + f3*(sqrt(Co2Conc.l("t1850"))-sqrt(c0));
